...
/* package nixos-package-updater-0.1.0.0 */
#ifndef VERSION_nixos_package_updater
#define VERSION_nixos_package_updater "0.1.0.0"
#endif /* VERSION_nixos_package_updater */
#ifndef MIN_VERSION_nixos_package_updater
#define MIN_VERSION_nixos_package_updater(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nixos_package_updater */
...
#define CURRENT_COMPONENT_ID "nixos-package-updater-0.1.0.0-inplace-nixos-package-updater"
