...
{-|
Module      : Paths_nixos_package_updater
...
-- at runtime using the environment variable nixos_package_updater_bindir.
...
-- environment variable nixos_package_updater_libdir.
...
-- using the environment variable nixos_package_updater_dynlibdir.
...
-- runtime using the environment variable nixos_package_updater_datadir.
...
-- variable nixos_package_updater_libexedir.
...
-- using the environment variable nixos_package_updater_sysconfdir.
...
bindir     = "/home/joowon/.cabal/bin"
libdir     = "/home/joowon/.cabal/lib/x86_64-linux-ghc-9.10.3-4467/nixos-package-updater-0.1.0.0-inplace-nixos-package-updater"
dynlibdir  = "/home/joowon/.cabal/lib/x86_64-linux-ghc-9.10.3-4467"
datadir    = "/home/joowon/.cabal/share/x86_64-linux-ghc-9.10.3-4467/nixos-package-updater-0.1.0.0"
libexecdir = "/home/joowon/.cabal/libexec/x86_64-linux-ghc-9.10.3-4467/nixos-package-updater-0.1.0.0"
sysconfdir = "/home/joowon/.cabal/etc"

getBinDir     = catchIO (getEnv "nixos_package_updater_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "nixos_package_updater_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "nixos_package_updater_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "nixos_package_updater_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "nixos_package_updater_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "nixos_package_updater_sysconfdir") (\_ -> return sysconfdir)
